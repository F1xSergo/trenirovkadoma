...
/* здесь представлено 2 присера жадного алгоритма. Первый
 это сортировка чисел от большего к меньшему в обратной последовательности
 Второй - вычесление оптимального количество остановок для машины, которая
 может проехать только 400км.staions - это остановки на определенный расстояниях.
 */
